#! /bin/bash
# DSKDv2 + Soft-DTW  |  Teacher: Qwen1.5-1.8B  →  Student: GPT-2 340M
...
DTW_PROJECTOR="${BASE_PATH}/results/gpt2/train/velocity_field/qwen1.5_1.8B_gpt2_340M/projector.pth"

DATA_DIR="${BASE_PATH}/processed_data/dolly/full/gpt2/"
LM_DATA_DIR="${BASE_PATH}/processed_data/openwebtext/gpt2/512/22.87K/"
SAVE_PATH="${BASE_PATH}/results/cross_tokenizer/dskdv2_dtw/qwen1.5_1.8B_gpt2_340M"
...
# d-student=1024 (GPT-2 340M), d-teacher=2048 (Qwen1.5-1.8B)
OPTS+=" --dtw-weight 1.0"
OPTS+=" --dtw-window 32"
OPTS+=" --dtw-gamma 0.1"
