#! /bin/bash
# DSKD + Soft-DTW  |  Teacher: Qwen2.5-7B  →  Student: GPT-2 1.5B
...
TOKEN_MAPPING="${BASE_PATH}/data/token_mapping/qwen2.5_7B_to_gpt2_id_mapping.json"
...
SAVE_PATH="${BASE_PATH}/results/cross_tokenizer/dskd_dtw/qwen2.5_7B_gpt2_1.5B"
