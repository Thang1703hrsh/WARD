#!/usr/bin/env bash
# ALM + Soft-DTW  |  Teacher: Mistral 7B  →  Student: TinyLLaMA 1.1B
#
# Usage:
#   bash scripts/cross_tokenizer/ALM/alm_dtw_mistral_7B_tinyllama_1.1B.sh [BASE_PATH] [N_DATA_PARALLEL] [N_MODEL_PARALLEL]
#
# Note: Mistral 7B and TinyLLaMA share the same LLaMA-family tokenizer,
# so this is effectively same-tokenizer distillation. Set target_tokenizer_name
# to match the student tokenizer.
...
TEACHER_TOKENIZER="mistralai/Mistral-7B-v0.1:source=Llama2"
...
echo "======================================================================="
echo "  ALM + Soft-DTW  |  Teacher: Mistral 7B  →  Student: TinyLLaMA 1.1B"
