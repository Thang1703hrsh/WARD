...
PEFT_CKPT="bachthetrollface/openllama2-3B-init-dolly-lora"
...
TEACHER_PEFT_CKPT="bachthetrollface/openllama2-7B-teacher-dolly-lora"
# data
DATA_DIR="${BASE_PATH}/data/distillm2/openllama2/formatted/"
# hp
BATCH_SIZE=16
LR=0.0005
GRAD_ACC=1
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/openllama2/train/velocity_field/distillm2"
# seed
SEED=10
