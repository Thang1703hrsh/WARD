...
VELOCITY_FIELD_CKPT="${BASE_PATH}/results/llama2/train/velocity_field/velocity_field.pth"
PROJECTOR_CKPT="${BASE_PATH}/results/llama2/train/velocity_field/projector.pth"
# data
...
MAX_LENGTH=512
# runtime
SAVE_PATH="${BASE_PATH}/results/llama2/train/dtw/distillm/7B_13B"
# seed
SEED=1031
